    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="container max-w-3xl mx-auto px-4 pb-20">
        ...
        <div className="space-y-5 text-zinc-800 leading-relaxed text-base md:text-lg">
          ...
          <p>
            He applied that background to his own weight loss. He has lost more than 80 lbs three separate times. Using LS Diet, he went from 310 lbs to 190 lbs, reaching that weight around November 2024. He has maintained the loss since, without repeated restarts, and his weight has not fluctuated more than 5 lbs in either direction.
          </p>
          <p>
