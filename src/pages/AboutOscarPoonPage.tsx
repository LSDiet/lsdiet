...
export default function AboutOscarPoonPage() {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>About Oscar Poon | Founder of LS Diet</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://lsdiet.com/about-oscar-poon" />
        ...
        <meta property="og:url" content="https://lsdiet.com/about-oscar-poon" />
        <script type="application/ld+json">{JSON.stringify({
          ...
          mainEntity: {
            ...
            url: "https://lsdiet.com/about-oscar-poon",
            sameAs: [
      ...
      <Navbar />
      <PageBreadcrumb items={[{ name: "Home", url: "/" }, { name: "About Oscar Poon", url: "/about-oscar-poon" }]} />
      ...
      <article className="container max-w-3xl mx-auto px-4 pb-20">
        ...
        <div className="space-y-5 text-[hsl(0_0%_85%)] leading-relaxed text-base md:text-lg">
          <p>
            ...
            method he teaches now. The diets worked. The behavioural infrastructure underneath them did not. That
            gap is what LS Diet exists to close.
          </p>
          <p>
            Today Oscar shares the low-starch, low-sugar lifestyle and the Weight Permanence Triangle™ through
            monthly mini-challenges on{" "}
            <a href="https://www.youtube.com/@JoinLSDiet" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
              YouTube (@JoinLSDiet)
            </a>
            , a weekly live webinar, and the free 7-day LS Diet course. The work is deliberately oriented around
            people who have already lost weight and don't want to do it again.
          </p>
          ...
          <p>
            Oscar holds a degree in psychology and spent over a year supporting clients at a substance-abuse
            centre in Vancouver. That work shaped how he thinks about cravings, identity, and relapse — the
            vocabulary of addiction recovery maps almost directly onto the cycle of losing and regaining weight.
            He also spent a decade as a surgical market-data consultant, which trained him to see patterns in
            messy human behaviour and to design systems that hold up in real environments rather than ideal ones.
          </p>
          <p>
            That mix — clinical psychology plus pattern analysis — is what makes LS Diet structurally different
            from typical diet content. The food framework is intentionally simple. The behavioural framework is
            where the real engineering lives. Read the breakdown on the{" "}
          ...
          <p>
            After the third restart, Oscar stopped looking for a better diet and started looking for the missing
            layer underneath every diet he had tried. The pattern was always the same: the food worked while life
            was calm; the food collapsed when life wasn't. The intervention had to operate above food, not below
            it. LS Diet is the result — a low-starch, low-sugar lifestyle paired with awareness work, daily
            practice, and permanence systems that course-correct early instead of demanding another restart.
          </p>
