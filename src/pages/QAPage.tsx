    ...
    questions: [
      ...
      },
      {
        ...
        awarenessList: [
          ...
          { stage: "Consequence Awareness", explanation: "The root of push motivation.", questions: ["Without being able to do X, what is that doing to your relationship?", "If you can't do X, what does that mean to you?", "Why do you want to change now? Why not wait for another 3, 6, or even 12 months?"] },
          { stage: "Autonomy Awareness", explanation: "The root of pull motivation.", questions: ["Let's suppose you lost 100 lbs, how will that change your life?", "If you can lose 10 lbs a month, and 80-100 lbs in a year, what does that mean to you?", "What will this new you do for your body, relationships, and emotional wellbeing?"] },
        ],
