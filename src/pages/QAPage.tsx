    ...
    questions: [
      ...
      },
      {
        ...
        awarenessList: [
          ...
          { stage: "Consequence Awareness", explanation: "The root of push motivation.", questions: ["Without being able to X, what is that doing to your relationship?", "If you can't do X, what does that mean to you?", "Why do you want to change now? Why not wait for another 3, 6, or even 12 months?"] },
