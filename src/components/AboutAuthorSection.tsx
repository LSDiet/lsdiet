          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-stretch">
            ...
            <div className="flex-1 space-y-4 text-center md:text-left flex flex-col justify-between">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                But just so you know Oscar isn't an AI — he has a degree in psychology, spent over a year helping clients at a substance abuse centre in Vancouver, and worked a decade as a surgical market data consultant. His specialty? Video Endoscopy and Integrated Operating Room Equipment. He shares his low-starch, low-sugar journey through monthly mini-challenges on{" "}
                <a 
