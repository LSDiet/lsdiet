...
export function HeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center pt-16 pb-8 overflow-hidden">
      ...
      <div className="container relative z-10 text-center max-w-4xl mx-auto px-4">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
          Discover the Weight Permanence Triangle™ Method — a neurobehavioral approach to losing weight, keeping it off, and living freely with a low starch, low sugar lifestyle.
        </p>
