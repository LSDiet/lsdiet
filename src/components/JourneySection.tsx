        ...
        <div className="relative group">
          <div className="aspect-[3/4] rounded-lg overflow-hidden bg-black">
            <img
              ...
              alt="Before"
              className={`block w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 ${card.id === 1 ? 'scale-[1.03]' : ''} ${card.id === 2 ? 'scale-[1.03] object-[center_20%]' : ''}`}
            />
          </div>
