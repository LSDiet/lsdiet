...
export function ContactSection() {
  ...
  return <section id="contact" className="py-5 bg-background">
      <div className="container">
        <div ref={ref} className={`max-w-2xl mx-auto transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="text-center mt-8">
            ...
            <a href="mailto:info@whataboutweight.com" className="inline-flex items-center gap-2 mt-2 text-primary hover:text-primary/80 font-medium transition-colors">
