import heroImage from "@/assets/blog/why-ozempic-face-happens-hero.jpg";
import type { Article } from "./types";

const meta: import("./types").ArticleMeta = {
  slug: "why-ozempic-face-happens",
  title: "Why Ozempic Face Happens, and What It Reveals About Muscle Loss",
  excerpt: "Ozempic face is not a side effect of the drug itself. It is what happens when facial fat and lean tissue disappear faster than skin and structure can adjust.",
  metaDescription: "Ozempic face comes from rapid facial fat and muscle loss, not the drug itself. Here is the research on why it happens and how to slow it down.",
  publishDate: "2026-07-02",
  updatedAt: "2026-07-02",
  canonicalTopic: "stop-weight-regain",
  topics: ["ozempic-face", "glp-1", "muscle-loss", "body-composition", "rapid-weight-loss"],
  ...
  heroImage: heroImage,
  heroImageAlt: "Close up of a person's face showing hollowed cheeks and fine lines associated with rapid weight loss on a GLP-1 medication",
};
