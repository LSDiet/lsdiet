...
import heroImage from "@/assets/blog/good-fat-bad-fat-high-protein-diet-hero.jpg";

const meta: import("./types").ArticleMeta = {
  slug: "good-fat-bad-fat-high-protein-diet",
  title: "Good Fat, Bad Fat: The Question High Protein Diets Never Answer",
  excerpt:
  ...
  heroImage,
  heroImageAlt:
    "Grilled salmon, avocado, and olive oil arranged next to butter and red meat, showing the difference between unsaturated and saturated fat sources",
};
