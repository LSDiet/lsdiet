...
import heroImage from "@/assets/blog/does-fibermaxxing-help-you-lose-weight-hero.jpg";

const meta: import("./types").ArticleMeta = {
  slug: "does-fibermaxxing-help-you-lose-weight",
  title: "Does Fibermaxxing Actually Help You Lose Weight, or Just Fill You Up?",
  excerpt:
    "Fibermaxxing only affects insulin the way people expect when the fiber comes from whole foods, not from an isolated additive stirred into a processed product.",
  metaDescription:
    "Fibermaxxing is trending, but not all fiber works the same way. Learn why whole food fiber lowers insulin demand and isolated fiber often does not.",
  ...
  heroImage,
  heroImageAlt:
    "Dried figs, apricots, prunes, dates, flaxseed, oat bran, and dried cranberries arranged around wooden letters spelling FIBER on a rustic white table",
};
