...
const meta = {
  ...
  title: "Yo-Yo Dieting Did Not Ruin Your Metabolism. It Did Something Worse.",
  excerpt: "The science is clear: weight cycling doesn't permanently damage your metabolism. But what it does damage is harder to fix.",
  metaDescription: "Yo-yo dieting does not permanently damage your metabolism. Here is what the research actually shows and why the myth is harder to shake than the facts.",
  publishDate: "2026-06-28",
  updatedAt: "2026-06-28",
  canonicalTopic: "stop-weight-regain",
  topics: ["weight-cycling", "metabolism", "identity-awareness", "reality-awareness"],
  ...
  heroImage,
  heroImageAlt: "Person standing on a bathroom scale looking frustrated, representing the emotional toll of repeated weight loss and regain cycles",
};
...
function Body() {
  return (
    <>
      ...
      <h2>References</h2>
      <p>
        City Attorney of San Francisco. (2025, December 2). <em>San Francisco City Attorney Chiu sues largest manufacturers of ultra-processed foods.</em> https://sfcityattorney.org/san-francisco-city-attorney-chiu-sues-largest-manufacturers-of-ultra-processed-foods/
      </p>
      <p>
        Magkos, F., &amp; Stefan, N. (2026). Is weight cycling clinically harmful? <em>The Lancet Diabetes &amp; Endocrinology</em>. https://doi.org/10.1016/S2213-8587(26)00037-9
      </p>
    </>
  );
}
