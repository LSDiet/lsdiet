...
const meta: import("./types").ArticleMeta = {
  slug: "oral-glp-1-pill-what-happens-when-you-stop",
  title: "No More Injections? The New Oral Weight Loss Pill and What Happens When You Stop",
  excerpt:
    "A new daily GLP-1 pill showed 10.5% weight loss in Phase 2 trials. The data on what happens after you stop is the part nobody is talking about.",
  metaDescription:
    "Elecoglipron is an oral GLP-1 drug that may replace injections. Here is what the science says about what happens when you stop taking it.",
  publishDate: "2026-06-24",
  updatedAt: "2026-06-24",
  canonicalTopic: "stop-weight-regain",
  topics: ["glp-1", "weight-loss-medication", "weight-regain", "behaviour-change", "identity"],
  primaryFoundationSlug: "friction-awareness",
  relatedFoundationSlugs: ["identity-awareness", "why-people-regain-weight-after-dieting"],
  heroImage: heroImage,
  heroImageAlt:
    "Person holding a small white pill between their fingers with a glass of water on the table nearby",
};
